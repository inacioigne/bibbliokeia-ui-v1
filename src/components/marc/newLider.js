...
export default function Lider(props) {
    //console.log("LEADER: ", props.meta?.[16])
  return (
    <Box>
      <Accordion>
        <AccordionSummary
        ...
        <Grid container spacing={2} gap={2} sx={{ p: 3, mt: 1 }}>
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[4] : "n"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[5] : "a"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[6] : "m"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[7] : "#"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            label="09 - Esquema de Codificação de Caracteres"
            select
            defaultValue={props.meta?  props.meta[8] : "a"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[16] : "4"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          <TextField
            ...
            select
            defaultValue={props.meta?  props.meta[17] : "a"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
          ...
          {/** Nível de registro de recurso em várias partes */}
          <TextField
            label="19 - Nível de registro de recurso em várias partes"
            select
            defaultValue={props.meta?  props.meta[18] : "#"}
            size="small"
            sx={{ width: 210 }}
            name="lider"
          >
